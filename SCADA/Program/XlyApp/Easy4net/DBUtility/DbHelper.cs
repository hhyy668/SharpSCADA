...
namespace Easy4net.DBUtility
{
    ...
    public class DBHelper
    {
        ...
        /// <param name="id">主键ID</param>
        /// <returns></returns>
        public int Remove<T>(object[] ids) where T : new()
        {
        ...
        {
            return session.ExcuteStoredProcReturnString(storedProcName, paras);
        }
        /// <summary>
        /// 执行带参数的存储过程返回记录集
        /// </summary>
        ...
        {
            return session.ExcuteStoredProc(storedProcName, paras);
        }
            /// <summary>
        /// 执行SQL返回记录集
        /// </summary>
        ...
        {
            return session.ExcuteSQLReturnDataSet(strSQL);
        }
        /// <summary>
        /// 根据SQL查询数量
        /// </summary>
